...
public class Interface {
        ...
        if(flag == 1) { // 잔액조회
            ...
            while(true) {
                ...
                if(cash != ((long)one_cnt*10000)+((long)five_cnt*50000)) {
                    JOptionPane.showInputDialog(null, "잘못입력하셨습니다! 다시 입력해주세요!");
                }
                else {
                    atm.one += one_cnt;
                    atm.five += five_cnt;
            ...
            while(true) {
                ...
                if(cash > db.getBalance(id)) {
                    JOptionPane.showInputDialog(null, "잔액이 부족합니다! 다시 입력해주세요!");
                    continue;
                }
                ...
                if(cash != ((long)one_cnt*10000)+((long)five_cnt*50000)) {
                    ...
                    if(one_cnt <= cmp_one && five_cnt <= cmp_five) {
                        ...
                        JOptionPane.showInputDialog(null, "ATM 기계의 지폐가 부족합니다! 다시 입력해주세요!");
                    }
                }
            }
            return cash;
    ...
    static void ATM_UI(DataBase db, ATM atm) {
    ...
    static void ShowDown() {
        JOptionPane.showInputDialog(null, "안녕히가세요 고객님!");
    }
}